								...
								<form class="form-horizontal">
									...
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" class="form-control"  placeholder="Email" value="raghadfrh11@gmail.com">
											</div>
										</div>
									</div>
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" class="form-control"  placeholder="Website" value="raghadfrh11@gmail.com">
											</div>
										</div>
									</div>
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" class="form-control"  placeholder="phone number" value="+963 937396343">
											</div>
										</div>
									</div>
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<textarea class="form-control" name="example-textarea-input" rows="2"  placeholder="Address">Syria, Damascus</textarea>
											</div>
										</div>
									</div>
									...
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" class="form-control"  placeholder="twitter" value="twitter.com/Raghad.me">
											</div>
										</div>
									</div>
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" class="form-control"  placeholder="facebook" value="https://www.facebook.com/RahadFarhoud">
											</div>
										</div>
									</div>
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" class="form-control"  placeholder="google" value="Raghad.com">
											</div>
										</div>
									</div>
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" class="form-control"  placeholder="linkedin" value="linkedin.com/in/Raghad">
											</div>
										</div>
									</div>
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" class="form-control" placeholder="github" value="github.com/Raghad">
											</div>
										</div>
									</div>
